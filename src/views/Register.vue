  ...
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <form @submit.prevent="register" class="p-8 flex flex-col bg-light-grey rounded-md shadow-lg">
      ...
      <div class="flex flex-col mb-2">
        ...
        <input v-model="email" type="email" required id="email" class="p-2 text-gray-500 focus:outline-none"/>
      </div>
      <div class="flex flex-col mb-2">
        <label for="password" class="mb-1 text-sm text-at-light-green">Password</label>
        <input v-model="password" type="password" required id="password" class="p-2 text-gray-500 focus:outline-none"/>
      </div>
      <div class="flex flex-col mb-2">
        <label for="confirmPassword" class="mb-1 text-sm text-at-light-green">Confirm Password</label>
        <input v-model="confirmPassword" type="password" required id="confirmPassword" class="p-2 text-gray-500 focus:outline-none" />
      </div>
